...
import { useLazyGetproject_submissionByIdQuery } from '../Api/Project_Submission_api/Project_Submission_api';
import HashLoader from "react-spinners/HashLoader";


const ProjectSubmissionPannel = ({ value, index }) => {

    const [trigger, { data, isSuccess, isError, error }] = useLazyGetproject_submissionByIdQuery()
    ...
    return (
        <CustomTabPanel value={value} index={index}>
            <div className='py-10'>
                <p className='text-[40px] font-semibold text-center'>Project Submission Score</p>
                <div>
...
export default ProjectSubmissionPannel