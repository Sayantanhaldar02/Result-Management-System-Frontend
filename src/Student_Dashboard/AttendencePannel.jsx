...
import { useLazyGetAttendenceByIdQuery } from '../Api/Attendence_api/Attendence_api';
...
const AttendencePannel = ({ value, index }) => {

    const [trigger, { data, isSuccess, isError, error }] = useLazyGetAttendenceByIdQuery()
    ...
    return (
        <CustomTabPanel value={value} index={index}>
            <div className='py-10'>
                <p className='text-[40px] font-semibold text-center'>Attendence Pannel</p>
                <div>
                    ...
                    <div className=' mt-20 w-[90%] mq900:w-[100%] mx-auto' >
                        ...
                        <TableContainer component={Paper} sx={{ maxHeight: 440 }} className='border-2 border-gray-500'>
...
export default AttendencePannel