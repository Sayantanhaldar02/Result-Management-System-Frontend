...
import { useLazyGetAssessmentByIdQuery } from '../Api/Assessment_api/Assessment_api';
...
const AssessmentPannel = ({ value, index }) => {

    const [trigger, { data, isSuccess, isError, error }] = useLazyGetAssessmentByIdQuery()
    ...
    return (
        <CustomTabPanel value={value} index={index}>
            <div className='py-10'>
                <p className='text-[40px] font-semibold text-center'>Assessment Pannel</p>
                <div>
...
export default AssessmentPannel