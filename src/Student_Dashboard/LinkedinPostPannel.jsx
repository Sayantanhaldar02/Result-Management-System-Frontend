...
import { useLazyGetlinkedin_postByIdQuery } from '../Api/Linkedin_Post_api/Linkedin_Post_api';
...
const LinkedinPostPannel = ({ value, index }) => {

    const [trigger, { data, isSuccess, isError, error }] = useLazyGetlinkedin_postByIdQuery()
    ...
    return (
        <CustomTabPanel value={value} index={index}>
            <div className='py-10'>
                <p className='text-[40px] font-semibold text-center'>Linkedin Post Score</p>
                <div>
...
export default LinkedinPostPannel