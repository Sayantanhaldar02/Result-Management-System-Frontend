...
import { useUploadproject_reviewMutation, useUpdateproject_reviewMutation, useDeleteproject_reviewMutation, useGetAllproject_reviewQuery } from '../../Api/Project_Review_api/Project_Review_api';
...
const Admin_Project_Review_Score_Upload = ({ value, index }) => {
    ...
    const handleClickUpdateFormOpen = (updateDetails) => {
        ...
        setStudentDetails({
            ...
            reviewScore: updateDetails.reviewScore,
    ...
    const [updateData, UpdateResponse] = useUpdateproject_reviewMutation()
    // Update Handeler
    ...
    const [uploadFile, UploadResponse] = useUploadproject_reviewMutation()
    // submit handeler
    const handelUploadFile = async () => {
        ...
        formData.append("projectReviewFile", file);
    ...
    const { data: fetchData, isLoading, isError, error, isSuccess, isFetching, refetch } = useGetAllproject_reviewQuery({ page, limit });
    ...
    const [deleteRecord, deleteResponse] = useDeleteproject_reviewMutation();
            ...
            <CustomTabPanel value={value} index={index}>
                <div className='my-[30px]'>
                    <div className='w-[100%] flex justify-between items-center py-4 px-2'>
                        <p className='text-[20px] font-semibold'>Project Review Score Upload</p>
            ...
            >
                ...
                <DialogContent>
                    <form className='w-full flex flex-col gap-4' >
                        ...
                        <TextField name='reviewScore' value={studentDetails.reviewScore} onChange={onChnageHandeler} id="outlined-basic" label="Review Score" variant="outlined" className='w-[100%] my-2' />
                        <TextField name='feedback' value={studentDetails.feedback} onChange={onChnageHandeler} id="outlined-basic" label="Feedback" variant="outlined" className='w-[100%] my-2' />
...
export default Admin_Project_Review_Score_Upload