...
import { useUploadlinkedin_postMutation, useUpdatelinkedin_postMutation, useDeletelinkedin_postMutation, useGetAlllinkedin_postQuery } from '../../Api/Linkedin_Post_api/Linkedin_Post_api';
...
const Admin_Linkedin_Post_Score_Upload = ({ value, index }) => {
    ...
    const [updateData, UpdateResponse] = useUpdatelinkedin_postMutation()
    // Update Handeler
    ...
    const [uploadFile, UploadResponse] = useUploadlinkedin_postMutation()
    // submit handeler
    const handelUploadFile = async () => {
        ...
        formData.append("linkedinPostFile", file);
    ...
    const { data: fetchData, isLoading, isError, error, isSuccess, isFetching, refetch } = useGetAlllinkedin_postQuery({ page, limit });
    ...
    const [deleteRecord, deleteResponse] = useDeletelinkedin_postMutation();
            ...
            <CustomTabPanel value={value} index={index}>
                <div className='my-[30px]'>
                    <div className='w-[100%] flex justify-between items-center py-4 px-2'>
                        <p className='text-[20px] font-semibold'>Linkedin Post Score Upload</p>
                                ...
                                <TableBody>
                                    {allData && allData.length > 0 && allData.map((row, index) => (
                                        ...
                                        >
                                            ...
                                            <TableCell align="center"><a href={row.postUrl} target="_blank" rel="noopener noreferrer" className='underline'>{row.postUrl}</a></TableCell>
            ...
            >
                ...
                <DialogContent>
                    <form className='w-full flex flex-col gap-4' >
                        ...
                        <TextField name='postUrl' value={studentDetails.postUrl} onChange={onChnageHandeler} id="outlined-basic" label="Post Url" variant="outlined" className='w-[100%] my-2' />
...
export default Admin_Linkedin_Post_Score_Upload